...
**Verification**: Every user story MUST include verification tasks. Use automated
tests when they exist or are added for the touched logic, and include manual
validation tasks whenever automation is absent.
...
> **NOTE:** Write automated tests first when they are part of the story's
> verification plan. If automation is not available, add explicit manual
> validation tasks before sign-off.

- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T012 [US1] Manual validation for [user journey] covering Telegram and
...
- [ ] T021 [US2] Manual validation for [user journey] covering Telegram and
      browser fallback behavior
...
- [ ] T028 [US3] Manual validation for [user journey] covering Telegram and
      browser fallback behavior
...
- [ ] TXXX [P] Additional unit tests or integration coverage in tests/unit/
...
### Within Each User Story
 ...
 - Verification tasks MUST be completed before sign-off for the story
 - Automated tests, when included, MUST be written and FAIL before implementation
 - Manual validation MUST cover the primary user journey and any Telegram-specific
   behavior touched by the story
